...
Platoon is really just a wrapper around Lavavel Envoy. In fact, there's a stock standard Envoy script that comes with Platoon which can be customized if need be. However, I have yet to find a reason to modify it.
