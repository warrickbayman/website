...
<template>
    <div>
        <div class="border border-neutral-500 rounded p-4">
            <img src="/images/mycalture.png" alt="HotPress Media" class="w-50 mb-5" />
            <table>
                <tr>
                    <td class="font-bold pr-4 text-neutral-500">URL:</td>
                    <td>
                        <a href="https://mycalture.com/" target="_blank" class="underline text-blue-400">https://mycalture.com/</a>
                    </td>
                </tr>
                <tr>
        ...
        <div class="typography max-w-2xl mt-5">
            <p>
                Mycalture is a really interesting business started by Mycal Hoffman in Johannesburg. It grew from
                strength to strength and at one point employed a team of 20 designers.
            </p>
            <p>
                In 2018 I was hired to lead a small team of 3 to help improve the quality of work. A previous developer
                had introduced them to Laravel, but not to any modern PHP tooling. I spent much of the first few months
            ...
            <p>
                Since starting out on my own Mycalture has remained a valuable client. I don't write a lot of code for
